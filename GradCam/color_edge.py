...
for numss in tqdm(range(ori_num[ll])):
    ...
    # make mask
    image = cv2.imread('../../fin_dataset/cifar10/train/ori_image/' + str(ll) + '/' + s + '.png')
    ...
    for k in range(num):
        if all_num[k] >= 4:
            ...
            if not os.path.exists('../../fin_dataset/cifar10/train/color_edge_image/' + str(ll) + '/' + s):
                os.makedirs('../../fin_dataset/cifar10/train/color_edge_image/' + str(ll) + '/'+ s)
            sk = "{:04d}".format(k)
            mask.save('../../fin_dataset/cifar10/train/color_edge_image/' + str(ll) + '/' + s + '/' + sk
