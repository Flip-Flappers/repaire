...
def deepfool(image, net, num_classes=10, overshoot=0.02, max_iter=10):
    f_image = net(transforms.Normalize([0.5, 0.5, 0.5], [0.5, 0.5, 0.5])(image))[0].cpu().data.numpy().flatten()
    ...
    fs = net.forward(transforms.Normalize([0.5, 0.5, 0.5], [0.5, 0.5, 0.5])(x[0]))[0]
...
for data in tqdm(trainloader):
    ...
    fin_label = net(transforms.Normalize([0.5, 0.5, 0.5], [0.5, 0.5, 0.5])(pert_image[0]))[0].argmax()
