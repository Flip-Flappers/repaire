...
# import torchvision.Pconv_models as Pconv_models
import torchvision.models as models_baseline # networks with zero padding
import Pconv_models as models_partial # partial conv based padding
...
def main():
    ...
    if args.pretrained:
        ...
        # model = Pconv_models.__dict__[args.arch](pretrained=True)
    else:
        ...
        # model = Pconv_models.__dict__[args.arch]()
